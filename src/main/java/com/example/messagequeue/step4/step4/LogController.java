...
@RestController
@RequestMapping("/step4/api/logs")
public class LogController {

    /**
     curl -X GET "http://localhost:8080/step4/api/logs/error"
     curl -X GET "http://localhost:8080/step4/api/logs/warn"
     curl -X POST "http://localhost:8080/step4/api/logs/info" -H "Content-Type: application/json" -d "\"System initialized successfully.\""
     */
